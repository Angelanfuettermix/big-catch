...
if($_POST["profile"]['profile_name']==''){
    $_POST["profile"]['profile_name'] = 'profile_'.date('Y-m-d_H:i:s');
}
  profile_save($_POST["profile"]['profile_name'], $_POST['profile'], $checked_ids);
...
<link rel="stylesheet" type="text/css" href="includes/pdfbill.css">
<script type="text/javascript" src="includes/general.js"></script>
<script type="text/javascript" src="includes/javascript/movablewindow.js" language="javascript1.2"></script>
...
<link rel="stylesheet" href="includes/js_color_picker_v2.css" media="screen">
<script type="text/javascript" src="includes/color_functions.js"></script>
<script type="text/javascript" src="includes/js_color_picker_v2.js"></script>
</head>
...
<table border="0" width="100%" cellspacing="2" cellpadding="2">
  <tr>
    ...
    <div  id="tag_column" style="display:none">
...
<!-- body_text //-->
    <td class="boxBillCenter" width="100%" valign="top">
	      ...
	      <tr>
	        <td width="100%" style="border:1px solid #666666;">
	        	<table border="0" width="100%" cellspacing="0" cellpadding="0" cellspacing="0">
		          <tr>
		            <td class="pageHeadingBill" rowspan="2" width="1%"><img border="0" src="images/pdfbill/pdf_logo.gif" width="44" height="41" vspace="10"></td>
		          ...
		          <tr>
		            <td  align="right" class="powered"><a target="_blank" id="imedes" href="http://www.alkim.info" onFocus="if(this.blur)this.blur()">Powered by ALKIM Media</a></td>
		          </tr>
       			</table>
       		</td>
      	</tr>
      ...
      <div class="createCat"><a id="HideShowColumn" onFocus="if(this.blur)this.blur()" href="javascript:void(0);" onclick="toggle_column()">Menü</a><div style="float:left;padding-top:4px;font-weight:bold;text-transform:uppercase;letter-spacing: 1px;"><?php echo PDFBILL_LOADED_PROFILE.'</div><div style="padding-top:4px">'.$profile_name ?></div><div style="clear:left"></div>
	</div>
...
<?php
      ...
      foreach( $profile_list as $p ) {
            ...
            <a id="btnDelProfile" onFocus="if(this.blur)this.blur()" href="<?php echo $PHP_SELF?>?del_sel_profile=<?php echo $p['profile_id'] ?>"><img border="0" src="images/pdfbill/btnDelete.gif" width="17" height="17" alt="Profil löschen" title="Profil löschen" /></a>
            <?php }  ?>
 ...
 <table  border="0" cellspacing="0" cellpadding="0" width="100%">
	  ...
	  <tr align="left">
        ...
        <table border="0" cellpadding="5" cellspacing="0"  class="TopSchema">
			<tr>
				<td>
				<div><img border="0" src="images/pdfbill/schema_01_top.png" width="190" height="234"></div><div class="gallerycontainerTop"><a class="thumbnail" href="#thumb"><img style="border:0px" src="images/pdfbill/zoom.gif" border="0" alt="zoom"><span><img src="images/pdfbill/schema_01_top_big.png" /></span></a></div></td>
				<td>
				<div><img border="0" src="images/pdfbill/schema_02_top.png" width="190" height="234"></div><div class="gallerycontainerTop"><a class="thumbnail" href="#thumb"><img style="border:0px" src="images/pdfbill/zoom.gif" border="0" alt="zoom"><span><img src="images/pdfbill/schema_02_top_big.png" /></span></a></div></td>
				<td>
				<div><img border="0" src="images/pdfbill/schema_03_top.png" width="190" height="236"></div><div class="gallerycontainerTop"><a class="thumbnail" href="#thumb"><img style="border:0px" src="images/pdfbill/zoom.gif" border="0" alt="zoom"><span><img src="images/pdfbill/schema_03_top_big.png" /></span></a></div></td>
			</tr>
		</table>
&nbsp;</td>
	  </tr>
...
?>
		<tr align="left">
	  	<td colspan="4" class="BilldataTableContent">
        <div class="OuterDiv"><img src="images/pdfbill/schema_10.png" border="0" width="150" height="91" alt="Hintergrund"></div><div class="gallerycontainer"><a class="thumbnail" href="#thumb"><img src="images/pdfbill/zoom.gif" border="0" alt="zoom"><span><img src="images/pdfbill/schema_10_big.png" /></span></a></div>
...
?>
		<tr align="left">
	  	<td colspan="4" class="BilldataTableContent">
        <div class="OuterDiv"><img  src="images/pdfbill/schema_5.png" border="0" width="150" height="91" alt="Kopftext"></div><div class="gallerycontainer"><a class="thumbnail" href="#thumb"><img src="images/pdfbill/zoom.gif" border="0" alt="zoom"><span><img src="images/pdfbill/schema_5_big.png" /></span></a></div>
	  	</td>
	  </tr>
<?php
...
?>
		<tr align="left">
	  	<td colspan="4" class="BilldataTableContent">
        <div class="OuterDiv"><img src="images/pdfbill/schema_1.png" border="0" width="150" height="91" alt="Addressblock"></div><div class="gallerycontainer"><a class="thumbnail" href="#thumb"><img src="images/pdfbill/zoom.gif" border="0" alt="zoom"><span><img src="images/pdfbill/schema_1_big.png" /></span></a></div>
...
?>
		<tr align="left">
	  	<td colspan="4" class="BilldataTableContent">
        <div class="OuterDiv"><img src="images/pdfbill/schema_3.png" border="0" width="150" height="91" alt="Decobild"></div><div class="gallerycontainer"><a class="thumbnail" href="#thumb"><img src="images/pdfbill/zoom.gif" border="0" alt="zoom"><span><img src="images/pdfbill/schema_3_big.png" /></span></a>
	  	</div>
	  	</td>
	  </tr>
<?php
...
?>
		<tr align="left">
	  	<td colspan="4" class="BilldataTableContent">
        <div class="OuterDiv"><img src="images/pdfbill/schema_9.png" border="0" width="150" height="91" alt="Datenfelder"></div><div class="gallerycontainer"><a class="thumbnail" href="#thumb"><img src="images/pdfbill/zoom.gif" border="0" alt="zoom"><span><img src="images/pdfbill/schema_9_big.png" /></span></a></div>
...
?>
		<tr align="left">
	  	<td colspan="4" class="BilldataTableContent">
        <div class="OuterDiv"><img src="images/pdfbill/schema_4.png" border="0" width="150" height="91" alt="Rechnungsüberschrift"></div><div class="gallerycontainer"><a class="thumbnail" href="#thumb"><img src="images/pdfbill/zoom.gif" border="0" alt="zoom"><span><img src="images/pdfbill/schema_4_big.png" /></span></a></div>
...
?>
		<tr align="left">
	  	<td colspan="4" class="BilldataTableContent">
        <div class="OuterDiv"><img src="images/pdfbill/schema_2.png" border="0" width="150" height="91" alt="Listenüberschrift"></div><div class="gallerycontainer"><a class="thumbnail" href="#thumb"><img src="images/pdfbill/zoom.gif" border="0" alt="zoom"><span><img src="images/pdfbill/schema_2_big.png" /></span></a></div>
...
?>
		<tr align="left">
	  	<td colspan="4" class="BilldataTableContent">
        <div class="OuterDiv"><img src="images/pdfbill/schema_7.png" border="0" width="150" height="91" alt="Positionslisten"></div><div class="gallerycontainer"><a class="thumbnail" href="#thumb"><img src="images/pdfbill/zoom.gif" border="0" alt="zoom"><span><img src="images/pdfbill/schema_7_big.png" /></span></a></div>
...
?>
		<tr align="left">
	  	<td colspan="4" class="BilldataTableContent">
        <div class="OuterDiv"><img src="images/pdfbill/schema_12.png" border="0" width="150" height="91" alt="Summenfelder"></div><div class="gallerycontainer"><a class="thumbnail" href="#thumb"><img src="images/pdfbill/zoom.gif" border="0" alt="zoom"><span><img src="images/pdfbill/schema_12_big.png" /></span></a></div>
...
?>
		<tr align="left">
	  	<td colspan="4" class="BilldataTableContent">
        <div class="OuterDiv"><img src="images/pdfbill/schema_8.png" border="0" width="150" height="91" alt="Untertext"></div><div class="gallerycontainer"><a class="thumbnail" href="#thumb"><img src="images/pdfbill/zoom.gif" border="0" alt="zoom"><span><img src="images/pdfbill/schema_8_big.png" /></span></a></div>
...
?>
		<tr align="left">
	  	<td colspan="4" class="BilldataTableContent">
        <div class="OuterDiv"><img src="images/pdfbill/schema_6.png" border="0" width="150" height="91" alt="Fusstexte"></div><div class="gallerycontainer"><a class="thumbnail" href="#thumb"><img src="images/pdfbill/zoom.gif" border="0" alt="zoom"><span><img src="images/pdfbill/schema_6_big.png" /></span></a></div>
...
?>
		<tr align="left">
	  	<td colspan="4" class="BilldataTableContent">
        <div class="OuterDiv"><img src="images/pdfbill/schema_11.png" border="0" width="150" height="91" alt="Anlage"></div><div class="gallerycontainer"><a class="thumbnail" href="#thumb"><img src="images/pdfbill/zoom.gif" border="0" alt="zoom"><span><img src="images/pdfbill/schema_11_big.png" /></span></a></div>
...
// ------------------------------------------------------------------------------------------------------
  ...
  tr_input('profile_name', array('question'=>'Name'), $profile['profile_name'], 40  );
...
/*
  tr_headline( array( 'headline' => '5. Wählen Sie die gew&uuml;nschten Optionen für die Anzeige der Produktnamen:' ) );
*/
...
?>
		<tr align="left">
          ...
          <img src="images/pdfbill/spacer.gif" id="hex_<?php echo $fieldname ?>" width="80" height="16" style="border:1px solid #818181">
        </div>
	  	 	<div>
...
function helpwindows_add( $text ) {
  ...
  if( $text!='' ) {
    ...
    $ret = " <a href=\"javascript: showMinWin('MWJminiwinMAX$i','MWJminiwinMIN$i');\"><img src=\"images/pdfbill/helpicon.gif\" border=\"0\" width=\"16\" height=\"16\" alt=\"help\"></a>";
...
?>
  a=getPosition('<?php echo $n ?>');
	...
	'Alkim Media - PDF Rechnung Helpdesk',  //The text to be written in the title bar of the mini window
	...
	'images/pdfbill/mv_logo.gif',             //The location of the logo image in the top left corner (16px x 16px)
	'images/pdfbill/mv_minimise.gif',        //The location of the minimise image (16px x 16px)
	'images/pdfbill/mv_restore.gif',          //The location of the restore image (16px x 16px)
	'images/pdfbill/mv_close.gif',            //The location of the 'close window' image (16px x 16px)
	'images/pdfbill/mv_maximise.gif',         //The location of the maximise image (16px x 16px) - use '' for not maximisable
