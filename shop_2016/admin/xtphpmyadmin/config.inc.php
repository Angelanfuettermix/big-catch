 ...
 */
$cfg['PmaAbsoluteUri'] = HTTP_SERVER.DIR_WS_ADMIN.'/xtphpmyadmin/';
...
$i++;
$cfg['Servers'][$i]['host']          = DB_SERVER; //'localhost'; // MySQL hostname or IP address
...
$cfg['Servers'][$i]['user']          = DB_SERVER_USERNAME; // 'root';      // MySQL user
$cfg['Servers'][$i]['password']      = DB_SERVER_PASSWORD; // 'root';          // MySQL password (only needed
                                                    // with 'config' auth_type)
$cfg['Servers'][$i]['only_db']       = DB_DATABASE; //S'';          // If set to a db-name, only
