<?php
  ...
  define('HTTP_CATALOG_SERVER', 'http://angelanfuettermix.de');
  define('HTTPS_CATALOG_SERVER', 'https://www.ssl-id.de/angelanfuettermix.de'); // eg, https://localhost - should not be empty for productive servers
  define('ENABLE_SSL_CATALOG', false); // secure webserver for catalog module
  define('USE_SSL_PROXY', false); // using SSL proxy?
  define('DIR_FS_DOCUMENT_ROOT', '/mnt/weba/d3/87/53714287/htdocs/shop_2016/'); // where the pages are located on the server
  define('DIR_WS_ADMIN', '/admin/');
  define('DIR_FS_ADMIN', '/mnt/weba/d3/87/53714287/htdocs/shop_2016/admin/'); // absolute pate required
