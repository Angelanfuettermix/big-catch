...
function createMiniWinLayer(mainContent,oTitle,oLeft,oTop,oWidth,barColour,mainColour,oLogo,oMin,oMax,oClose,oFull,oDrag,oVis,oFullDrag,anyExtra,oScroll) {
	...
	if( document.layers && !document.childNodes ) {
		...
		document.write( '<layer bgcolor="#bfbfbf"  name="MWJminiwinMAX'+window.MWJ_MINIWINS+'" width="'+oWidth+'" left="'+oLeft+'" top="'+oTop+'" visibility="'+((oVis==1)?'show':'hide')+'"'+(oFullDrag?theDragString:'')+'>'+
			...
			'<img src="'+oLogo+'" border="0" height="16" width="16" alt="PDF Katalog - Powered by ALKIM Media"></a></td>'+
		...
		document.write(
			...
			'<a style="text-decoration:none;cursor:pointer;" href="javascript:manuf();" onfocus="this.blur()" onmouseover="window.status=\'Click for information about creating these mini windows\';return true;" onmouseout="window.status=\'\';return true;" title="PDF Katalog - Powered by ALKIM Media">'+
			'<img src="'+oLogo+'" border="0" height="16" width="16" alt="PDF Katalog - Powered by ALKIM Media"></a></td>'+
...
function manuf() {
	window.alert('PDF Katalog - Powered by ALKIM Media\n'+
		'\nhttp://www.alkim.info für Support und andere Module');
}