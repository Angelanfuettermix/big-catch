<?php
define(IPDFBILL_VERSION, 'V1.11.0');
define(IPDFBILL_DATE, '18.08.2008');


require_once( DIR_FS_CATALOG.'includes/classes/xtcPrice.php' );

require_once( DIR_FS_ADMIN.'includes/classes/fpdf/fpdf.php');
require_once( DIR_FS_ADMIN.'includes/classes/pdf_datacell.php' );

require_once( DIR_FS_ADMIN.'includes/classes/order_pdf.php' );

require_once (DIR_FS_INC.'xtc_get_order_data.inc.php');
require_once (DIR_FS_INC.'xtc_get_attributes_model.inc.php');

define( ATTACHMENT_TXT, DIR_FS_ADMIN.'includes/pdfbill/pdf_attachment.txt' );
...
define( PDF_IMAGE_DIR, DIR_FS_ADMIN.'images/pdfbill/user/' );
...
class pdfbill_cl extends PDF_Clipping {
  ...
  function pdfbill_cl( $parameter_arr, $orders_id, $demomode=false ) {
    parent::PDF_Clipping();
    ...
    if( $this->parameter_arr['bgimage_display']=='1' ) {
      ...
      if( file_exists($file) ) {
        ...
        $this->format_text( '',
                            ...
                            'arial',
                            10  );
        $this->Cell(50, 30, 'Error: File '.$file.' doesn\'t exists.' );
      }
    }
...
class pdfbill extends pdfbill_cl {
  ...
  function pdfbill( $parameter_arr, $orders_id, $demomode=false ) {
    ...
    parent::pdfbill_cl($parameter_arr, $orders_id, $demomode );
  }
  ...
  function LoadData($oID, $data_special_parameters=array() ) {
    global $xtPrice;

    $this->data['data_special_parameters'] = $data_special_parameters;
