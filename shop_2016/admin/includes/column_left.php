...
echo ('<ul>');
  if (($_SESSION['customers_status']['customers_status_id'] == '0')) echo '<li><a href="' . xtc_href_link(FILENAME_GOOGLE_SITEMAP, 'auto=true') . '" class="menuBoxContentLink"> -' . BOX_GOOGLE_SITEMAP . '</a></li>';
  if (($_SESSION['customers_status']['customers_status_id'] == '0') && ($admin_access['alkim_module'] == '1')) echo '<li><a href="' . xtc_href_link('alkim_module.php') . '" class="menuBoxContentLink"> -' . BOX_ALKIM_MODULE . '</a></li>';
  ...
  if (($_SESSION['customers_status']['customers_status_id'] == '0') && ($admin_access['it_recht_kanzlei'] == '1')) echo '<li><a href="' . xtc_href_link(FILENAME_IT_RECHT_KANZLEI, '') . '" class="menuBoxContentLink"> -' . BOX_IT_RECHT_KANZLEI . '</a></li>';
