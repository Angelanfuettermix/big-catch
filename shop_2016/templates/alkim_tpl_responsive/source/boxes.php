...
//  require_once DIR_WS_BOXES . 'infobox.php';
  ...
  require_once DIR_WS_BOXES . 'socialmedia.php';
  require_once DIR_WS_BOXES . 'contentmenu.php';
  require_once DIR_WS_BOXES . 'payment.php';
// -----------------------------------------------------------------------------------------
...
//    require_once DIR_WS_BOXES . 'manufacturer_info.php';
    require_once DIR_WS_BOXES . 'subcategories.php';
    require_once DIR_WS_BOXES . 'last_viewed.php';
    require_once DIR_WS_BOXES . 'my_product_box.php';
  } else {
...
// -----------------------------------------------------------------------------------------
  if (FILENAME_DEFAULT == basename($PHP_SELF) && isset($cPath) && xtc_not_null($cPath) || $product->isProduct()) {
    require_once DIR_WS_BOXES . 'subcategories.php';
    require_once DIR_WS_BOXES . 'specials.php';
    require_once DIR_WS_BOXES . 'my_product_box.php';
    require_once DIR_WS_BOXES . 'best_sellers.php';
...
//	Angebote
// -----------------------------------------------------------------------------------------
  if (FILENAME_SPECIALS == basename($PHP_SELF)) {
    require_once DIR_WS_BOXES . 'my_product_box.php';
    require_once DIR_WS_BOXES . 'best_sellers.php';
  }
// -----------------------------------------------------------------------------------------
