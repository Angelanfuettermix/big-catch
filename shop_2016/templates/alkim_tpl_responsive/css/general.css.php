...
<?php if(MIXXXER_INCOMP_DISPLAY=='hide'){
?><style>
...
if (strstr($_PHP_SELF, 'mixxxer.php' )) {
echo '<link rel="stylesheet" href="templates/'.CURRENT_TEMPLATE.'/css/mixxxer.css" type="text/css" />';
}
?>
<?php
/*
