...
$but_bg_color  = '#3d86a8'; // txt u. Hintergrundfarbe d. Einkauf Fortsetzen Buttons 
$but_txt_color = '#ffffff'; 

$smarty->assign('BUTTON_CONTINUE_SHOPPING', xtc_image_button('button_continue_shopping.gif', IMAGE_BUTTON_CONTINUE_SHOPPING, ' style="background-color:'.$but_bg_color.';color:'.$but_txt_color.';" '));
