...
if (CURRENT_TEMPLATE =='alkim_tpl_responsive') {;
    define('IMAGE_BUTTON_CHECKOUT', 'Zur Kasse / Bestellung abschlie&szlig;en');
} else {
...
// --- changes -- h.koch for alkim-media -- 03.2016 --  
...
define('TEXT_GREETING_PERSONAL', 'Sch&ouml;n, dass du wieder da bist, <span class="greetUser">%s!</span> M&ouml;chtest du dir unsere <a style="text-decoration:underline;" href="%s">neuen Artikel</a> ansehen?');
