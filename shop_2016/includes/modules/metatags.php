...
// ---------------------------------------------------------------------------------------
  $content_noIndex = array(2,3,4,7,9);
// ---------------------------------------------------------------------------------------
//  Ende Konfiguration
// ---------------------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------------------
  case FILENAME_PRODUCT_INFO :
    ...
    if($product->isProduct()) {
      ...
      /* BOC - alkimmedia (DK) */
      // robots
      if(!empty($product->data['products_meta_robots'])){
        $meta_robots = $product->data['products_meta_robots'];
      }
      // date
      if(!empty($product->data['products_meta_date'])){
        $meta_date = $product->data['products_meta_date'];
      }
      // google-site-verification
      if(!empty($product->data['products_meta_google_site_verification'])){
        $meta_google_site_verification = $product->data['products_meta_google_site_verification'];
      }
...
// BOF - Alkim Media - 2015-03-28 - Flexi responsive Template
echo '<meta name="viewport" content="width=device-width, initial-scale=1.0, user-scalable=no" />';
// EOF - Alkim Media - 2015-03-28 - Flexi responsive Template
...
if(isset($meta_google_site_verification)){
    echo '<meta name="google-site-verification" content="'.$products_meta_google_site_verification.'" />'."\n";
}
?>
