...
$ret["item_list"] = '<div class="fi_list_line">';
$ret["item_list"].= '  <div class="fi_list_col1"><b>Ergänzungen</b></div>';
$ret["item_list"].= '  <div class="fi_list_col2">&nbsp;</div>';
$ret["item_list"].= '</div>';
$ret["item_list"].= $_SESSION["c_mix"]->give_item_list2();


$d = $_SESSION["c_mix"]->resort();
$d = '<pre>'.print_r(  $d,true  ).'</pre>';  
$ret['debug_list'] = $d;
...
// --- bof -- changes -- h.koch for alkim-media -- 03.2016 -- 
$ret["base_item2"] = '<div class="fi_list_line">';
$ret["base_item2"].= '  <div class="fi_list_col1"><b>Meine Basis</b></div>';
$ret["base_item2"].= '  <div class="fi_list_col2">('.(1000-$ret["qty"]).'g)</div>';
$ret["base_item2"].= '</div>';
$ret["base_item2"].= $_SESSION["c_mix"]->baseItem2;
// --- eof -- changes -- h.koch for alkim-media -- 03.2016 -- 
...
foreach($_SESSION["c_mix"]->items AS $item){           
    $ret["prices"][$item["id"]] = $xtPrice->xtcFormat($item["price"]*100, true, 0,false,0,0,2);
    if($item["percent"] != 0){
            ...
            $q = "SELECT mi.mi_id FROM mixxxer_items mi, mixxxer_items_to_mixxxer_groups mi2mg 
              ...
              while ($mi_r = mysql_fetch_array($mi_rs)){
                 ...
                 if($mg_r["mg_id"] == BASE_MG_ID){
                    $ret["prices"][$mi_r["mi_id"]] = $xtPrice->xtcFormat($price*100, true, 0,false,0,0,2);
                 }else{
                    $ret["prices"][$mi_r["mi_id"]] = $xtPrice->xtcFormat($price*100, true, 0,false,0,0,3).'/100g';
                 }
...
//$ret["delete_link"] = '<a href="'.xtc_href_link('mixxxer_ajax_helper.php', 'action=delete_mix&del_num='.$_SESSION["mixxxer"]->current_mixxx_index).'" class="feature_ajax_link mixxxer_button"><img style="float:left" src="alkimmedia_modules/mixxxer/images/mixxxer_delete_icon.png" alt="'.DELETE_MIX.'" /> <div class="mixxxer_icon_text">'.DELETE_MIXTURE.'</div></a>';
$ret["delete_link"] = '<a href="'.xtc_href_link('mixxxer_ajax_helper.php', 'action=delete_mix&del_num='.$_SESSION["mixxxer"]->current_mixxx_index).'" class="feature_ajax_link mixxxer_button"><img src="alkimmedia_modules/mixxxer/images/mixxxer_delete_icon.png" alt="'.DELETE_MIX.'" /></a>';
// --- eof -- changes -- h.koch for alkim-media -- 03.2016 --
